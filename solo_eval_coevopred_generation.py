...
if len(sys.argv) != 5:
    print >>sys.stderr, "USAGE: evaluation_replicate_generation.py <phase2_dir> <predator_spop> <evaluation_out_dir> <population_from_update>"
    sys.exit(1)
    ...
    for hist_conting in hist_contings:
        for treatment in ["pred", "nopred"]:
            for phase2_rep in range(1, 31):
                ...
                shutil.copytree(solo_skel_dir["nopred"], "/tmp/fishjord_tmp_phase3_solo_skel/")
